...
const CHAT_HISTORY_KEY = 'cooking_tutor_history';
const PENDING_REQUESTS_KEY = 'cooking_tutor_pending_requests';
...
const translations = {
    "EN": {
    header: "Cooking Tutor",
    tooltip: "Hello, what would you like to cook today?",
    upload_tooltip: "",
    welcomeText: "Hi! I’m your friendly cooking tutor. Ask me for recipes, techniques, substitutions, and step-by-step guidance for any dish.",
    ...
    about: "About",
    loaderMessage: "ChefBot is gathering the tastiest tips and reliable sources..."
    },
    "VI": {
    header: "Trợ Lý Nấu Ăn",
    tooltip: "Xin chào, hôm nay bạn muốn nấu món gì?",
    upload_tooltip: "",
    welcomeText: "Chào bạn! Tôi là trợ lý nấu ăn thân thiện, sẵn sàng gợi ý công thức, kỹ thuật và mẹo nấu nướng chi tiết.",
    acknowledgement: "Ghi công",
    ...
    about: "Thông Tin",
    loaderMessage: "Đầu Bếp Bot đang tìm nguồn uy tín và mẹo nấu ăn hay..."
    },
    "ZH": {
    header: "烹饪导师",
    tooltip: "您好，今天想做什么菜？",
    upload_tooltip: "",
    welcomeText: "您好！我是您的烹饪导师，可提供食谱、技巧、替代食材与步骤指导。",
    acknowledgement: "致谢",
    author: "作者：黎登科",
    ...
    subscription: "订阅",
    about: "关于",
    loaderMessage: "厨师机器人正在为您收集可靠来源与烹饪技巧…"
    }
};
...
function updateLanguage(lang) {
    ...
    // Upload tooltip removed for cooking theme
...
function toggleInputMode(mode) {
    ...
    // Upload mode removed for cooking theme
    } else if (mode === 'video') {
